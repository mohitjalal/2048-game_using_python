...
#draw game over and restart the game again.
def draw_over():
...
#take your turn based on the birection passed.
...
def draw_board():
    ...
    high_score_text=font.render(f'High_Score{high_score}',True,'black')
